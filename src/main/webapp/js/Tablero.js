class Tablero {
  constructor(ko) {
    ...
    for (let i = 0; i < 8; i++) {
      filas[i] = new Array();
      for (let j = 0; j < 8; j++) filas[i][j] = new Casilla(ko, null);
    }
...
class Casilla {
  ...
  letra() {
    if (this.pieza() != null) return this.pieza().letra();
    return " ";
  }
}
...
class Torre extends Pieza {
  ...
  letra() {
    if (this.color == "BLANCO") return "T";
    else if (this.color == "NEGRO") return "t";
  }
}
...
class Caballo extends Pieza {
  ...
  letra() {
    if (this.color == "BLANCO") return "C";
    else if (this.color == "NEGRO") return "c";
  }
}
...
class Alfil extends Pieza {
  ...
  letra() {
    if (this.color == "BLANCO") return "A";
    else if (this.color == "NEGRO") return "a";
  }
}
...
class Dama extends Pieza {
  ...
  letra() {
    if (this.color == "BLANCO") return "D";
    else if (this.color == "NEGRO") return "d";
  }
}
...
class Rey extends Pieza {
  ...
  letra() {
    if (this.color == "BLANCO") return "R";
    else if (this.color == "NEGRO") return "r";
  }
}
...
class Peon extends Pieza {
  ...
  letra() {
    if (this.color == "BLANCO") return "P";
    else if (this.color == "NEGRO") return "p";
  }
}
